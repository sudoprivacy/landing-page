...
> **用途：** 场景案例区块，"销售与获客" 分类的配图
> **尺寸：** 800×600
> **文件名：** scenario-sales.png
...
Color palette: Amber (#F59E0B) for AI agents and highlights, teal (#0D9488) for data elements, dark charcoal (#1a1a1a) for text/lines, warm cream (#FAF9F0) background. Flat geometric style, no realistic people. Clean and professional, suitable for enterprise B2B. Light subtle shadows for depth.

## 用途说明
代表"AI 帮销售团队自动准备方案、做尽调、盯客户"的场景。
